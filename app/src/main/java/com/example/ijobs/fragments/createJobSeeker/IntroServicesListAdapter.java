...
public class IntroServicesListAdapter extends ArrayAdapter<ServiceOfferListItemViewModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.create_job_seeker_profile_intro_services_listitem, parent, false);
        TextView textView = rowView.findViewById(R.id.create_job_seeker_profile_service_item_text);
